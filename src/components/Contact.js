...
const Contact = () => {
  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      value: "arbazdogar20@gmail.com",
      link: "mailto:arbazdogar20@gmail.com",
    },
    // {
    //   icon: (
    //     <svg
    ...
    // },
    {
      ...
      title: "Location",
      value: "Paris, FR",
      link: "https://maps.google.com/?q=Paris, FR",
    },
    {
      icon: (
        <svg
      ...
      title: "Resume",
      value: "Download CV",
      link: "/cv/Muhammad-Arbaz-Dogar.pdf",
      download: true,
    },
  ];
  ...
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/arbazdogar20",
      icon: (
    ...
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/muhammadarbazdogar",
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="container">
        ...
        <div className={styles.content}>
          <div className={styles.contactInfo}>
            <h3 className={styles.sectionSubtitle}>Let's Connect</h3>
            ...
            <div className={styles.infoList}>
              {contactInfo.map((info, index) => (
                <a
                  key={index}
                  href={info.link}
                  target={info.download ? undefined : "_blank"}
                  rel={info.download ? undefined : "noopener noreferrer"}
                  download={
                    info.download ? "Muhammad_Arbaz_Dogar_CV.pdf" : undefined
                  }
