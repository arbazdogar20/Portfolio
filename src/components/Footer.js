...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: "LinkedIn",
      href: "https://linkedin.com/in/muhammadarbazdogar",
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: "Email",
      href: "mailto:arbazdogar20@gmail.com",
      icon: (
        <svg
          width="20"
          height="20"
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <div className={styles.linksSection}>
            ...
            <div className={styles.linkGroup}>
              ...
              <ul className={styles.linkList}>
                <li>
                  <span className={styles.link}>Frontend Development</span>
                </li>
                <li>
                  <span className={styles.link}>Backend Development</span>
                </li>
                <li>
                  <span className={styles.link}>Full Stack Solutions</span>
                </li>
              </ul>
            </div>
            ...
            <div className={styles.linkGroup}>
              ...
              <ul className={styles.linkList}>
                <li>
                  <a
                    href="mailto:arbazdogar20@email.com"
                    className={styles.link}
                  >
                    arbazdogar20@email.com
                  </a>
                </li>
                {/* <li>
                ...
                <li>
                  <span className={styles.link}>Paris, FR</span>
                </li>
                <li>
                  <a
        ...
        <div className={styles.bottom}>
          <div className={styles.copyright}>
            <p>© {currentYear} Muhammad Arbaz Dogar. All rights reserved.</p>
          </div>
